...
public class TestOozieAuditLogParser {
  ...
  @Test public void testParser() throws Exception {
    ...
    String logline =
        "2016-04-27 15:01:14,526  INFO oozieaudit:520 - IP [192.168.7.199], USER [tangjijun], GROUP [pms], APP [My_Workflow], JOBID [0000000-160427140648764-oozie-oozi-W], "
    ...
    Assert.assertEquals(1461740474526L, obj.timestamp);

  }

  @Test public void testParserNotMatch() throws Exception {
